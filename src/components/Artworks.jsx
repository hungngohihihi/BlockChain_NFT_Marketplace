...
const Card = ({ nft }) => {
  ...
  return (
    <div className="w-full shadow-xl justify-center shadow-#7b7b7b rounded-md overflow-hidden #7b7b7b my-2 p-3">
      <img
        src={nft.metadataURI}
        alt={nft.title}
        className="h-80 w-full object-cover shadow-lg shadow-#7b7b7b rounded-lg mb-3"
      />
      ...
      <div className="flex items-center justify-center mt-3 text-black">
        <button
          className=" shadow-lg shadow-black text-white text-sm bg-[#7b7b7b] hover:bg-[#000000] cursor-pointer rounded-full px-1.5 py-2 "
          onClick={setNFT}
        >
          View Details
        </button>
